...
test('tooltips', async ({page}) => {
    ...
    page.getByRole('tooltip') // if you vae a role tooltip created
...
test('web tables', async ({page}) => {
    ...
    // 2 get the row by value in the column
    ...
    for ( let age of ages ) {
        ...
        await page.waitForTimeout(500) //await ageFilter
        //await ageFilter.press('Enter')
