...
export class DatePickerPage extends HelperBase {
    ...
    async selectDatePickerWithRangeFromToday(startDaysFromToday: number, endDaysFromToday: number) {
        ...
        await calendarInputField.click()
        const startDateToAssert = await this.selectDateInTheCalendar(startDaysFromToday)

        await calendarInputField.click()
        const endDateToAssert = await this.selectDateInTheCalendar(endDaysFromToday)
